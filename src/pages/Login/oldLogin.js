...
//                 <InputLabel labelValue="Nome" id="name" value={name} onChange={handleNameChange} />
//                 <InputLabel labelValue="E-mail" id="email" value={email} onChange={handleEmailChange}  />
//                 <InputLabel labelValue="Senha" id="password" type="password" value={password} onChange={handlePasswordChange} />
//                 <InputLabel labelValue="Confirmar Senha" id="confirmPassword" type="password" onChange={handleConfirmPasswordChange} />
//               </div>
//               <div className="button-group">
